...
class Pebble(object):
    ...
    def powerpoint(self):
      ...
      #  self.notification_sms("KeynoteOSX", "Keynote has connected to your pebble")
        ...
        self.set_nowplaying_metadata("Slide #"+str(keynote.slideshows()[0].currentSlide().slideNumber()), str(keynote.slideshows()[0].masterSlides()[0].slides()[0].title()).rstrip('\n')[0:27]+"...","@JFKingsley")
        log.info(body)

    #DEMO - UP button was pressed
    def powerpoint_play(self):
        keynote = SBApplication.applicationWithBundleIdentifier_("com.apple.iWork.Keynote")
        keynote.slideshows()[0].stopSlideshow()
        self.set_nowplaying_metadata("Slide #"+str(keynote.slideshows()[0].currentSlide().slideNumber()), str(keynote.slideshows()[0].masterSlides()[0].slides()[0].title()).rstrip('\n')[0:27]+"...","@JFKingsley")
        
    #DEMO - DOWN button was pressed     
    def powerpoint_prev(self):
        keynote = SBApplication.applicationWithBundleIdentifier_("com.apple.iWork.Keynote")
        keynote.slideshows()[0].showPrevious()
        self.set_nowplaying_metadata("Slide #"+str(keynote.slideshows()[0].currentSlide().slideNumber()),  str(keynote.slideshows()[0].masterSlides()[0].slides()[0].title()).rstrip('\n')[0:27]+"...","@JFKingsley")
        
    #DEMO - SELECT button was pressed.
    def powerpoint_next(self):
        keynote = SBApplication.applicationWithBundleIdentifier_("com.apple.iWork.Keynote")
        keynote.slideshows()[0].advance()
        self.set_nowplaying_metadata("Slide #"+str(keynote.slideshows()[0].currentSlide().slideNumber()),  str(keynote.slideshows()[0].masterSlides()[0].slides()[0].title()).rstrip('\n')[0:27]+"...","@JFKingsley") 
